...
import (
	...
	mockdb "github.com/narymbaev/simple-bank/db/mock"
	db "github.com/narymbaev/simple-bank/db/sqlc"
	tok "github.com/narymbaev/simple-bank/token"
...
func TestGetAccountAPI(t *testing.T) {
	...
	testCases := []struct {
		name          string
		accountID     int64
		setupAuth func(t *testing.T, request *http.Request, tokenMaker tok.Maker)
